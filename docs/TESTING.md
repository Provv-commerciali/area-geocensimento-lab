...
Vitest covers Zod validators, civic generation/parity/deduplication, filter semantics, structured floors, controlled vocabularies, subject/property many-to-many traversal, persistence outcomes, appraisal invariants and repository contracts. React Testing Library covers private/company/existing-subject flows, strong-identifier suggestions, cascade behavior, absence of interview fields from property creation and visible database failures. Playwright smoke specifications cover login/demo entry, zone/street flow, property creation/filtering, subject sheets, contextual street contacts and complex interiors.
