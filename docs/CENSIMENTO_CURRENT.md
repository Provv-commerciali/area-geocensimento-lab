...
The primary operational concept and navigation entry is the Census Contact. A contact may be a private person or a company and remains attached to its zone/street/civic context, optional complex, property data and interview history. Internally, a normalized Subject registry supports reuse across contacts without becoming an autonomous management area. Subjects and records are many-to-many with Proprietario, Comproprietario or Inquilino roles. During Nuovo contatto the operator can select an existing registry entry; matching CF/P.IVA prompts reuse, while names never merge automatically. Contact types confirmed are Generico, Informatore, Informazione and Notizia. Appraisal is manual and defaults false even for Notizia.
