...
- **DEC-027** — Nominatim is a replaceable LAB geocoding adapter for explicit, limited searches only. Opening or moving the map never triggers geocoding. Persisted civic geocoding is the cache boundary.
