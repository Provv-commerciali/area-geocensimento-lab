...
export default async function Dashboard() {
  ...
  return <><PageHeader eyebrow="Quadro operativo" title="Censimento LAB" description="Territorio, proprietà, soggetti e attività in un’unica vista di lavoro." action={<Link className="button primary" href="/censimento/contatti/nuovo">Nuova proprietà <ArrowRight size={17}/></Link>}/><DataModeNotice databaseMode={hasSupabaseEnvironment()}/>
