...
import { civics, complexes, countries, municipalities, operators, provinces, records, regions, streets, zones } from "@/lib/demo-data";
...
export const demoCensusRepository: CensusRepository = {
  ...
  async listCountries() { return countries; }, async listRegions() { return regions; }, async listProvinces() { return provinces; }, async listMunicipalities() { return municipalities; },
};
