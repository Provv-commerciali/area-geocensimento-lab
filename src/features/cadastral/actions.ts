...
import { getCadastralDocumentUrl, linkCadastralHolderToSubject, pollCadastralRequest, requestOrdinaryReport, requestPropertyHolders, requestPropertyUnits } from "@/services/cadastral-data-service";
