...
export function GeoCensusMap({ records, civics, zones, streets, complexes, operators, settings, today, initialFilters }: Props) {
  ...
  useEffect(() => {
    ...
    map.on("singleclick", async (event) => {
      ...
      const url = parcelInfo.getFeatureInfoUrl(event.coordinate, map.getView().getResolution()!, "EPSG:3857", { INFO_FORMAT: "text/plain" });
