...
export async function createCensusRecordAction(
  ...
  const record = {
    ...
    contactType: value(data, "contactType"), engagementType: value(data, "engagementType"), engagementExpiresOn:value(data,"engagementExpiresOn"), relationshipRole: value(data, "relationshipRole"), inherited: data.get("inherited") === "on",
