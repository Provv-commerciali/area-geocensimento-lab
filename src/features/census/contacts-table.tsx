...
export function ContactsTable({ records, zones, streets, complexes, operators, operationalSettings, operationalToday, fixedZoneId, fixedStreetId, initialFilters }: Props) {
  ...
  return <>
    ...
    <section className="table-panel">
      ...
      <div className="table-scroll"><table><thead><tr><th>Contatto</th><th>Qualifica</th><th>Tipologia</th><th>Tipo incarico</th><th>Stato operativo</th><th>Zona / Indirizzo</th><th>Occupazione</th><th>Piano</th><th>Giorni dall'ultimo contatto</th><th>Ricontatto</th><th>Complesso</th><th>Ereditato</th><th>Azioni</th></tr></thead><tbody>{visible.map((record) => {
