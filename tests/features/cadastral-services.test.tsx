...
vi.mock("@/features/cadastral/actions",()=>({findPropertyUnitsAction:mocks.findPropertyUnitsAction,getPropertyHoldersAction:vi.fn(),requestOrdinaryReportAction:vi.fn(),pollCadastralRequestAction:vi.fn(),linkCadastralHolderAction:vi.fn(),getCadastralDocumentUrlAction:vi.fn()}));
